...
class ODLTable(object):
    ...
    def l2output(self, flow_name, in_port, connector_id, source, destination, template_dir):
        """
    ...
    def l3output(self, flow_name, in_port, connector_id, source, destination, template_dir):
        """
